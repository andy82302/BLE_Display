...
public class BluetoothLeService extends Service {
    ...
    public final static String EXTRA_DATA_RAW =
            "com.example.bluetooth.le.EXTRA_DATA_RAW";
...
//        return false;
    ...
    public void writeOTABootLoaderCommand(BluetoothGattCharacteristic characteristic, int[] value) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            return;
        } else {
            byte[] data = new byte[value.length];
            for(int a = 0; a < value.length; a++){
                data[a]=(byte)(value[a]&0xff);
            }
